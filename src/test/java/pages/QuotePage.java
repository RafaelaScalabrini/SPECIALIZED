...
public class QuotePage extends BasePage {
    public QuotePage(WebDriver driver) {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(d -> d.findElement(By.xpath("//li[@class='idealsteps-step-active']//a[@id='sendquote']")));
    }
    ...
    protected String CommentsTextAreaField = "//textarea[@id='Comments']";
    ...
    public void fillOutTheQuoteForm() {
        ...
        driver.findElement(By.xpath(PasswordInputField)).sendKeys("Rambo2024");
        driver.findElement(By.xpath(ConfirmPasswordInputField)).sendKeys("Rambo2024");
        driver.findElement(By.xpath(CommentsTextAreaField)).sendKeys("Selenium comments");
        click(driver.findElement(By.xpath(SendButton)));

    }

    public boolean ValidateTheSweetAlertMessageHasSuccess(){
        return new WebDriverWait(driver, Duration.ofSeconds(15)).until(new ExpectedCondition<Boolean>() {
